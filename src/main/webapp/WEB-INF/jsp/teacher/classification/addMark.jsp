...
<c:if test="${message.negativeFull}">
  ...
  ${message.negativeMes}
            ...
            <div class="container">
                <div class="row">
                   <p class="alert-info"><strong>Údaje označené symbolem <span class="glyphicon glyphicon-asterisk"></span> jsou povinné.</strong></p>
                    ...
                    <f:form class="form-horizontal" commandName="form" action="addMark.htm" method="POST">
                        <f:errors path="*" element="div" cssClass="alert alert-info" />
                        <div class="form-group">
                            <f:label path="nameOfMark" class="col-lg-2 control-label">Název známky<span class="glyphicon glyphicon-asterisk"></span>:</f:label>
                            <div class="col-lg-5">
                            <f:input path="nameOfMark" id="nameOfMark" cssClass="form-control"/>
                            <f:errors path="nameOfMark" element="div" cssClass="alert alert-info"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <f:errors path="markDate" element="div" cssClass="alert alert-info"/>
        ...
        <br/>
        <div class="btn-group">       
       <button class="btn btn-primary" type="submit"><strong> Přidat známku</strong></button>
       <a href="<c:url value="/teacher/classification/studentInfo.htm?idSubject=${form.idSubject}&idStudent=${form.id}&next=0&previous=0"/>"
                   class="btn btn-danger"> Zrušit
