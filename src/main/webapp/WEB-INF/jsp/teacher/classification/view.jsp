            ...
            <div class="container">
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tfoot></tfoot>
                        <tbody>
                            <c:forEach items="${subjectClass}" var="item" varStatus="iter">
                                <tr>
                                    <td>${iter.index+1}</td>
                                    <td>${item.id_subject.name}</td><td>
                                        <a href="<c:url value="classification/classView.htm?idSubject=${item.id_subject.id}"/>" class="btn btn-info"><span class="glyphicon glyphicon-info-sign"></span></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                        ...
                        <c:otherwise>
                            <p class="alert alert-warning">Nevyučujete žádný předmět</p>
                        </c:otherwise>
                    </c:choose>
