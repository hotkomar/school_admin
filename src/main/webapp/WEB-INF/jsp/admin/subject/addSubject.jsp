...
<div class="panel-heading">
    ...
    <h2 class="panel-title">  Přidat nový předmět</h2>
        ...
        <div class="panel-body">
            ...
            <f:form   class="form-horizontal" commandName="form" action="adminNewSubject.htm" method="POST">
            ...
            <a class="btn btn-danger" href="<c:url value="/admin/subjects.htm"/>"> Zrušit</a>
