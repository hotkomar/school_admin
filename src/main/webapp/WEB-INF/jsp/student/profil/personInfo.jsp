            ...
            <div class="col-lg-3">
               <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>Třídní učitel:</th>   <td><a href="<c:url value="headTeacher.htm"/>"> ${students.id_class.id_teacher.degree} ${students.id_class.id_teacher.name} ${students.id_class.id_teacher.surname}</a></td>
                    </tr>
