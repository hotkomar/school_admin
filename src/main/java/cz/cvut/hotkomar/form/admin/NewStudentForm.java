...
import cz.cvut.hotkomar.service.valid.LoginMatch;
...
@LoginMatch(login = "login", message = "Uživatel s títmto přihlašovacím jménem existuje")
@BornMatch(born = "dateOfBorn",message = "Datum je špatně zadané nebo neexistuje")
public class NewStudentForm implements Form{
    private Long id;
    ...
    message = "Login musí mít minimálně 4 znaky a maximálně 30 znaků. Povolené znaky jsou písmena abecedy (bez diakritiky), číslice 0 až 9 a podtržítko.")
   ...
   public boolean isValidFile () 
   {
    ...
    public void setBorn(Calendar born) {
        ...
        if(born!=null)
        {
          ...
          dateOfBorn=  dateFunction.getDateString(born);
        }
    }
