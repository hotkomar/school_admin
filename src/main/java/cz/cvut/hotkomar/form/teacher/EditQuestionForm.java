 ...
 * @author Maru
 */
public class EditQuestionForm implements Serializable{
  private Long id;
 ...
 @Valid
    private List<EditAnswerForm> answers= new ArrayList<EditAnswerForm>();  
 ...
 private Boolean isAnswerEmpty()
 {
    ...
    public List<EditAnswerForm> getAnswers() {
        return answers;
    }

    public void setAnswers(List<EditAnswerForm> answers) {
